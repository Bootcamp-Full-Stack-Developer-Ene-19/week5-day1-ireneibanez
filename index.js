...
function setInstructions() {
    moves = window.prompt('Introduzca coordenadas de movimiento');
    return moves;
}
        ...
        for (let i=0 ; i < moves.length; i++){
            switch (moves[i]) {
                ...
                if (moveNorth()) {
                    ...
                    console.log ('No puede continuar por este camino');
                ...
                default:
                console.log ('Parámetro no válido');
                return;
                break;
            }
        }
...
console.log('Los movimientos posibles son: N, S, E y W');
var map = generateMap();
printMap(map, character);